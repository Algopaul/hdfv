...
from hdfv.histogram_videos import (_dot_offsets, _to_pixel,
                                   angle_color_coded_frames, histogram_frames,
                                   trace_frames)
...
def test_trace_frames_trail_accumulates():
  ...
  frames = list(
      trace_frames(data, resolution=64, trail_decay=1.0, dot_intensity=1.0))
